...
var emptystarImg,onestarImg,twostarImg,emptystar;
...
function preload()
{
  ...
  emptystarImg = loadImage("empty.png")
...
function setup() 
{
  ...
  airblower.mouseClicked(Vforce)

  emptystar = createSprite(50,20,30,30)
  emptystar.scale = .2
  emptystar.addAnimation("empty",emptystarImg)
  emptystar.addAnimation("one",onestarImg)
  emptystar.addAnimation("two", twostarImg)
  emptystar.changeAnimation("empty")
...
function draw() 
{
  ...
  if(collide(fruit,star1,40)===true){
    star1.visible = false
    emptystar.changeAnimation("one")
    
 }
  if(collide(fruit,star2,20)===true){
    star2.visible = false
    emptystar.changeAnimation("two")
  }
}
